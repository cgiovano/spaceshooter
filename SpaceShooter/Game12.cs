...
namespace SpaceShooter
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            renderTarget = new RenderTarget2D(graphicsDevice, 800, 480);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, null, null, null, Matrix.CreateScale(1f, 1f, 0));
        ...
        void DrawSceneToRenderTarget(RenderTarget2D target)
        {
            ...
            spriteBatch.Begin(SpriteSortMode.Deferred, BlendState.AlphaBlend, SamplerState.PointClamp, DepthStencilState.None, RasterizerState.CullNone, null, Matrix.CreateScale(1f));
